    ...
    return <div className="ltn__contact-message-area mb-120 ">
				...
				<div className="row">
					...
					<div className="ltn__form-box contact-form-box box-shadow white-bg">
						<h4 className="title-2">Send Us Message</h4>
						...
						<div className="btn-wrapper mt-0">
							<button className="btn theme-btn-1 btn-effect-1 text-uppercase disabled_btn" type="submit" disabled>Send Messagesty</button>
						</div>
